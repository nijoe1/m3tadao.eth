...
const useContract = () => {
    ...
    // const createProjectAccount = async (accountID, groupID, accountName, image, description) => {
    //     let imageURI
    //     if (image) {
    //         imageURI = await uploadFileToIpfs(image, "image")
    //     } else {
    ...
    //     valist.createAccount(accountName, {name: accountName, description: description} );
